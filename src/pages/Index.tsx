          ...
          {!selectedCampaign ? (
            ...
            <>
              ...
              <div className="mt-5 mb-4">
                <FilterBar selectedChannels={selectedChannels} sort={sort} selectedCount={selectedAssets.size} showInsights={selectedChannels.length > 0} onChannelsChange={setSelectedChannels} onSortChange={setSort} />
              </div>
