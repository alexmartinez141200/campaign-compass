          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex flex-col items-end gap-4">
              <button
                ...
                className="inline-flex shrink-0 items-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-3.5 py-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-foreground shadow-sm transition-colors hover:bg-primary/15"
              >
                ...
                <div className="relative z-10 w-[min(760px,calc(100vw-2rem))] rounded-xl border border-border bg-background p-4 shadow-2xl">
                  ...
                  <div className="mt-4 rounded-lg border border-border/60 bg-muted/20 p-3">
                    <div className="flex items-end justify-between gap-3">
                      ...
                      <button
                        type="button"
                        className="shrink-0 rounded-md border border-primary/30 bg-primary/10 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-foreground transition-colors hover:bg-primary/15"
                      >
                        Take Me to Design
                      </button>
                    </div>
